...
FunctionPass *createPreserveNonePass();
ModulePass *createPreserveNoneInfectionPass();
...
void initializeX86PreserveNonePassPass(PassRegistry &);
void initializeX86PreserveNoneInfectionPassPass(PassRegistry &);
